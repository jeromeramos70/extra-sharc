...
from model.base_explain import Module
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_batch', default=1, type=int, help='training batch size')
    ...
    parser.add_argument('--model', default='base_t5', help='model to use')
    parser.add_argument('--pretrained_lm_path', default='roberta-base', help='path/to/pretrained/lm')
    ...
    parser.add_argument('--data_type', default='decision_roberta_base', help='data type, b:base bert, l: large bert, u: uncased, c: cased')
    ...
    if args.resume:
        ...
        print('pretrained_lm_path', args.pretrained_lm_path)
